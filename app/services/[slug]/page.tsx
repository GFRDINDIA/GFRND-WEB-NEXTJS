...
import { ArrowLeft, CheckCircle2, Building2, ArrowRight } from 'lucide-react';
...
export default function ServiceDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-screen bg-white font-sans">
      ...
      {/* ── Hero ───────────────────────────────────────────────────── */}
      <section className={`bg-gradient-to-br ${service.categoryColor} relative overflow-hidden`}>
        {/* subtle grid pattern */}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Key Features</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {service.features.map((feature, i) => (
              <motion.div
                ...
                whileHover={{ y: -3 }}
              >
                <div className={`w-10 h-10 rounded-xl bg-gradient-to-r ${service.categoryColor} flex items-center justify-center mb-4`}>
                  <CheckCircle2 className="h-5 w-5 text-white" />
                </div>
                <h3 className="text-base font-semibold text-gray-900 mb-2 tracking-tight">{feature.title}</h3>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Real-World Use Cases</h2>
            <div className="w-12 h-1 bg-gradient-to-r from-blue-600 to-green-500 rounded-full mx-auto" />
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-5">
            {service.useCases.map((uc, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <div className={`w-10 h-10 rounded-xl bg-gradient-to-r ${service.categoryColor} flex items-center justify-center flex-shrink-0`}>
                  <Building2 className="h-5 w-5 text-white" />
                </div>
                <div>
                  <span className="text-xs font-bold uppercase tracking-widest text-gray-400 block mb-1">{uc.industry}</span>
                  <p className="text-sm text-gray-700 leading-relaxed">{uc.example}</p>
                </div>
              </motion.div>
            ))}
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 tracking-tight">Why Choose Us</h2>
      ...
      {/* ── CTA ─────────────────────────────────────────────────────── */}
      <section className={`py-16 bg-gradient-to-br ${service.categoryColor}`}>
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-white/80 text-base mb-8 max-w-xl mx-auto">
              Let&apos;s discuss how {service.name} can drive real results for your organisation.
            </p>
            <Link
              href="/#contact"
